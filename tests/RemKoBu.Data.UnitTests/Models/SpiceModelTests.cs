...
namespace RemKoBu.Data.UnitTests.Models
{
    public class SpiceModelTests
    {
        ...
        {
            SpiceModel spiceModel = new SpiceModel {SpiceId = 111};
        ...
        {
            SpiceModel spiceModel = new SpiceModel {SpiceName = "A delicious spice"};
        ...
        {
            SpiceModel spiceModel = new SpiceModel {ImagePath = @"C:\good\path"};
