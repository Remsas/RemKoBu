...
namespace RemKoBu.Data.UnitTests.Models
{
    public class RecipeSpiceModelTests
    {
        ...
        {
            RecipeSpiceModel recipeSpiceModel = new RecipeSpiceModel();
            recipeSpiceModel.RecipeSpiceId = 111;
        ...
        {
            RecipeSpiceModel recipeSpiceModel = new RecipeSpiceModel();
            recipeSpiceModel.SpiceQuantity = 444;
        ...
        {
            RecipeSpiceModel recipeSpiceModel = new RecipeSpiceModel();
            recipeSpiceModel.SpiceMeasureUnit = "A measure unit";
