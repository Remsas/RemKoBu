...
namespace RemKoBu.Data.UnitTests.Models
{
    public class IngredientModelTests
    {
        ...
        public void PropertyIngredientId_SetValue_StoresCorrectly()
        {
            ...
            ingredientModel.IngredientId = 5;
        ...
        {
            IngredientModel ingredientModel = new IngredientModel();
            ingredientModel.IngredientCategoryId = 4;
        ...
        {
            IngredientModel ingredientModel = new IngredientModel();
            ingredientModel.IngredientName = "Eine leckere Zutat";
        ...
        {
            IngredientModel ingredientModel = new IngredientModel();
            ingredientModel.KcalPer100G = 111;
        ...
        {
            IngredientModel ingredientModel = new IngredientModel();
            ingredientModel.FatPer100G = 444;
        ...
        {
            IngredientModel ingredientModel = new IngredientModel();
            ingredientModel.ImagePath = @"C:\Windows\system32";
